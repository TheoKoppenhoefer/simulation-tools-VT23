...
In the following we use the model of a pendulum attached to a rod which is elastic in the radial direction as described in Task 1. In particular our ODE is given by
\begin{align*}
...
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_1}
...
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_2}
...
\begin{itemize}
	...
	\begin{align*}
		E_{\text{tot}}=E_{\text{tot}}+E_{\text{tot}}+E_{\text{tot}}
	\end{align*}
\end{itemize}
We expect the approximate total energy to be constant which indeed can be seen in Figure \ref{pl:EnergyPlot1}.
Because of this property we can use the relative variation of the approximate total energy as an index measuring the (in)stability of the solver. Specifically we implement
\begin{python}
    instability_index = (np.max(total_energy)-np.min(total_energy))/np.mean(total_energy)
\end{python}
...
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_3}
\caption{Energy plot}
...
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_200}
\caption{nsteps in dependence of the parameter $k$.}
\label{pl:nsteps1}
\end{minipage}
\hfill
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_201}
\caption{nfuncs in dependence of the parameter $k$.}
\label{pl:nfcns1}
\end{minipage}
\end{figure}
...
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_210}
\caption{nfcns / nsteps in dependence of the parameter $k$.}
\label{pl:nfcns_nsteps1}
\end{minipage}
\hfill
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_211}
\caption{njacs / nsteps in dependence of the parameter $k$.}
...
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_212}
\caption{nerrfails / nsteps in dependence of the parameter $k$.}
\label{pl:nerrfails_nsteps1}
\end{minipage}
\hfill
\begin{minipage}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{../Plots/Figure_204}
\caption{instability index in dependence of the parameter $k$.}
\label{pl:stability1}
\end{minipage}
\end{figure}
