...
In a second experiment we test the dependence of the implicit Newmark method on the parameters $\beta$ and $\gamma$ whereby we keep the parameter $\alpha=0$ and the stepsize $h=0.05$ constant. The plot of the \pyth{stability_index} can be seen in figure \ref{pl:beam_exp_betagamma_alpha0}
