...
For Explicit Euler \(Figure \ref{exp_euler_k=50_h=0.001_c}\), by keeping the value of $k$ constant and reducing the step size by a decimal place we can see how the instability is attenuated presenting a similar amplitude over time.
...
\caption{\pyth{njacs/nsteps} Implicit Euler $h=0.01$ $k=50$}
...
\caption{\pyth{nfcns/nsteps} BDF2-Fixed Point $h=0.001$ $k=500$}
\label{exp_euler_k=50_h=0.001_c}
\end{minipage}
\hfill
\begin{minipage}[b]{0.45\textwidth}
...
\caption{\pyth{njacs/nsteps} BDF2-Fixed Point $h=0.01$ $k=1000$}
...
To better observe this decay \(Figure \ref{bdf2_h=0.01_h=100_tf=100.png} & Figure \ref{bdf4_h=0.01_h=100_tf=100.png}\) the domain is increased to $\[0, 100\]$.
...
\caption{\pyth{nfcns/nsteps} BDF2-Newton $h=0.01$ $k=100$}
...
\caption{\pyth{njacs/nsteps} BDF4-Newton $h=0.01$ $k=100$}
